...
namespace Hermes.Authentication
{
	...
	public class AuthenticationTest : TestClassBase, IDisposable
	{
		...
		[TestMethod]
		public void Authorization_APIAuthorization_Unauthorized()
		{
			//UserGroupController.ClearTestUserData();

			var request = new HttpRequestMessage(HttpMethod.Get, string.Concat(Config.ApiRouteVersion, "APIAuthorization"));
			request.Headers.Add("Authorization", AuthorizationHeader);
		...
		[TestMethod]
		public void Authorization_APIAuthorization_Authorized()
		{
			//UserGroupController.ClearTestUserData();
		...
		public void Authentication_With_Cookies_Success()
		{
			...
			var cookieValue = "SecureTicketString";
