...
namespace Hermes.WebApi.Extensions.Owin.Externals
{
	...
	public class ExternalData
	{
		...
		/// <exception cref="HermesException">Invalid access.
		/// or
		/// Invalid access.
		/// or
		...
		public ExternalData(ClaimsIdentity identity)
		{
			if (identity == null)
			{
				throw new HermesException("Invalid access.");
			}
			...
			{
				throw new HermesException("Invalid provider key/Issuer.");
			}

			if (providerKeyClaim.Issuer == ClaimsIdentity.DefaultIssuer)
			{
				throw new HermesException("Issuer is default.");
			}
