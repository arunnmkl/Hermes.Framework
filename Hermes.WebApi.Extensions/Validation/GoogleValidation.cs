using Hermes.WebApi.Base.NetHttp;
...
namespace Hermes.WebApi.Extensions.Validation
{
	...
	/// </summary>
	/// <seealso cref="Hermes.WebApi.Extensions.Owin.Externals.IExternalValidation" />
	public class GoogleValidation : IExternalValidation
	{
		...
		{
			get { return "https://www.googleapis.com/oauth2/v1/tokeninfo?access_token={0}"; }
		}
