    ...
    internal class AuthorizationCommands
    {
        ...
        public static Dictionary<string, Resource> ResourcesByName
        {
            get
            {
                ...
                Dictionary<Guid, Resource>.ValueCollection values = AuthorizationCommands.Resources.Values;
        ...
        public static Resource GetResource(Guid id)
        {
            ...
            {
                throw new AuthorizationException(string.Format("Invalid Logical Resource Id: {0}", (object)id));
            }
        ...
        public static Resource GetResource(string name)
        {
            ...
            {
                throw new AuthorizationException(string.Format("Invalid Resource Name: {0}", (object)name));
            }
        ...
        public static Permission GetPermission(int id)
        {
            ...
            {
                throw new AuthorizationException(string.Format("Invalid Permission Id: {0}", (object)id));
            }
        ...
        public static Permission GetPermission(string name)
        {
            ...
            {
                throw new AuthorizationException(string.Format("Invalid Permission Name: {0}", (object)name));
            }
